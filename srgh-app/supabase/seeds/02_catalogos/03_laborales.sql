...
VALUES
  ...
  (8,  'PEN002', 'Pensión por Invalidez',                    false, true,  'Art. 85 Código de Trabajo. Genera cesantía; no genera preaviso (MTSS DAJ-AE-69-10: al acogerse a la pensión no se concede ni se exige preaviso).'),
  (9,  'FAL001', 'Fallecimiento del Trabajador',             false, true,  'Art. 85 inciso a) Código de Trabajo. Cesantía a derechohabientes.'),
