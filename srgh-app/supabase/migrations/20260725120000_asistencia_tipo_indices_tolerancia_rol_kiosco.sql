...
-- ─── 4. Rol KIOSCO ─────────────────────────────────────────────────────────
INSERT INTO public.sgrh_cat_roles (rol_codigo, rol_nombre, rol_descripcion)
VALUES ('KIOSCO', 'Kiosco de asistencia', 'Cuenta de dispositivo compartido: solo registra marcas de asistencia')
